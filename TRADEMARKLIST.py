...
class trademarkdetails:
    ...
    def __init__(self,my_frame):
        ...
        self.mytable = ttk.Treeview(self.mytablearea, columns=('SERIAL NO.','APPLICATION','APPLICATION DATE', 'NAME','TRADEMARK','DETAILS','CLASS','STATUS','CONTACT', 'EMAIL','TMJ','RENEWAL','ADDRESS','TIME'),
        ...
        try:
                ...
                with myobj.cursor() as myconn:
                    sql_query="select serial,Application,ApplicationDate,Name,Trademark,userdetail,Class,Status,Contact,Email,TMJ,Renewal,Address,Time from mytable order by serial"
                    try:
