...
class Classdetails:
    def __init__(self,my_frame):
        ...
        mywindow.title("Class Detail Details")
        ...
        self.mytable = ttk.Treeview(self.mytablearea, columns=("Class"),
        ...
        self.mytable.heading('Class', text="Classes")
        ...
        try:
                ...
                with myobj.cursor() as myconn:
                    sql_query="select Class from classes "
                    try:
